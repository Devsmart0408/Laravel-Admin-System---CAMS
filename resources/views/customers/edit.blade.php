...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Edit a Customer</h4>
        </div>
    </div>
</div>
<!-- end page title -->
...
<div class="row">
    <div class="col">
        ...
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="{{route('customers.update', $res_data->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                <div class="card-box">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control @if($errors->has('first_name')) is-invalid @endif"
                                       type="text" name="first_name" id="inputFirstname" value="{{ $res_data->first_name}}" placeholder="First Name" />
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control @if($errors->has('last_name')) is-invalid @endif"
                                       type="text" name="last_name" id="last_name" value="{{ $res_data->last_name}}" placeholder="Last Name" />
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control @if($errors->has('company_name')) is-invalid @endif"
                                       type="text" name="company_name" id="company_name" value="{{ $res_data->company_name}}" placeholder="Company Name" />
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control @if($errors->has('customer_code')) is-invalid @endif"
                                       type="text" name="customer_code" id="customer_code" value="{{ $res_data->customer_code}}" placeholder="Customer Code" />
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control @if($errors->has('phone')) is-invalid @endif"
                                       type="text" name="phone" id="phone" value="{{ $res_data->phone}}" placeholder="Phone" />
                                @if($errors->has('phone'))
                                <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control @if($errors->has('fax')) is-invalid @endif"
                                       type="text" name="fax" id="fax" value="{{ $res_data->fax}}" placeholder="Fax" />
                                @if($errors->has('fax'))
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control @if($errors->has('mobile')) is-invalid @endif"
                                       type="text" name="mobile" id="mobile" value="{{ $res_data->mobile}}" placeholder="Mobile" />
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control @if($errors->has('email')) is-invalid @endif"
                                       type="email" name="email" id="email" value="{{ $res_data->email}}" placeholder="Email" />
                                @if($errors->has('email'))
                                <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" name="birthday" id="birthday" value="{{ $res_data->birthday}}" class="form-control" @if($errors->has('birthday')) is-invalid @endif" 
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control @if($errors->has('eco_ben')) is-invalid @endif"
                                       type="text" name="eco_ben" id="eco_ben" value="{{ $res_data->eco_ben}}" placeholder="Economic Beneficiary" />
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control @if($errors->has('address')) is-invalid @endif"
                                       type="text" name="address" id="address" value="{{ $res_data->address}}" placeholder="Address" />
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control @if($errors->has('city')) is-invalid @endif"
                                       type="text" name="city" id="city" value="{{ $res_data->city}}" placeholder="City" />
                                @if($errors->has('city'))
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control @if($errors->has('country')) is-invalid @endif"
                                       type="text" name="country" id="country" value="{{ $res_data->country}}" placeholder="Country" />
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="hidden" name="hidden_password" value="{{$res_data->password}}">
                    ...
                    <h4 class="card-title mt-3">Primary Information</h4>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control @if($errors->has('name_id')) is-invalid @endif"
                                        type="text" name="name_id" id="name_id" value="{{ $res_data->name_id}}" placeholder="Name On ID" />
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control @if($errors->has('id_type')) is-invalid @endif"
                                        type="text" name="id_type" id="id_type" value="{{ $res_data->id_type}}" placeholder="ID Type" />
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control @if($errors->has('id_number')) is-invalid @endif"
                                        type="text" name="id_number" id="id_number" value="{{ $res_data->id_number}}" placeholder="ID Number" />
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                ...
                                <input class="form-control @if($errors->has('place_issue')) is-invalid @endif"
                                       type="text" name="place_issue" id="place_issue" value="{{ $res_data->place_issue}}" placeholder="Place Of Issue" />
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input class="form-control @if($errors->has('place_birthday')) is-invalid @endif"
                                       type="text" name="place_birthday" id="place_birthday" value="{{ $res_data->place_birthday}}" placeholder="Place of Birthday" />
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input class="form-control @if($errors->has('national')) is-invalid @endif"
                                       type="text" name="national" id="national" value="{{ $res_data->national}}" placeholder="national" />
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="text" name="expire_date" id="expire_date" value="{{ $res_data->expire_date}}" class="form-control" @if($errors->has('expire_date')) is-invalid @endif" 
                                            data-provide="datepicker" data-date-autoclose="true" data-date-format="yyyy-mm-dd">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="ti-calendar"></i></span>
                                    </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                @endif
                                <img src="{{ URL::to('/') }}/images/users/{{ $res_data->id_img }}" class="img-thumbnail" id="id-img-tag" style="width:100%;margin-top: 10px"/>
                                <input type="hidden" name="hidden_id_img" value="{{ $res_data->id_img }}" />
                            ...
                            <div class="form-group col-md-4">
                                ...
                                @endif
                                <img src="{{ URL::to('/') }}/images/users/{{ $res_data->company_img }}" class="img-thumbnail" id="company-img-tag" style="width:100%;margin-top: 10px"/>
                                <input type="hidden" name="hidden_company_img" value="{{ $res_data->company_img }}" />
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                @endif
                                <img src="{{ URL::to('/') }}/images/users/{{ $res_data->mix_img }}" class="img-thumbnail" id="mix-img-tag" style="width:100%;margin-top: 10px"/>
                                <input type="hidden" name="hidden_mix_img" value="{{ $res_data->mix_img }}" />
                            </div>
                        </div>
