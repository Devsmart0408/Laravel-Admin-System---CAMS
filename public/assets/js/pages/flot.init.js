...
!function ($) {
  ...
  FlotChart.prototype.init = function () {
    ...
    var plabels = ["Bitcoin", "Ethereum"];
    var pcolors = ['#3bafda', '#1abc9c'];
    ...
    var colors = ["#3bafda", "#26c6da", "#80deea", "#00b19d", "#d1dee4"];
    ...
    var donutcolors = ["#3bafda", "#26c6da", "#80deea", "#00b19d", "#d1dee4"];
    ...
    this.createStackBarGraph("#ordered-bars-chart", stack_ticks, ['#e3eaef', '#3bafda', '#1abc9c'], ds); //creating line chart
    ...
    this.createLineGraph("#line-chart-alt", line_ticks, ['#3bafda', '#1abc9c'], line_data);
  }, //init flotchart
...
module.exports = __webpack_require__(/*! E:\WORSPACE\CAMS\workspace\backend\resources\js\pages\flot.init.js */"./resources/js/pages/flot.init.js");
